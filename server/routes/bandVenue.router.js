...
router.get('/band/:id', (req, res) => {
    ...
    const queryText = `SELECT "id", "bandname", "description", "twitter", "facebook", "www", "youtube", 
...
router.get('/venue/:id', (req, res) => {
    ...
    const queryText = `SELECT "id", "venuename", "description", "address", "twitter", "facebook", "www", "youtube", "phone", 
